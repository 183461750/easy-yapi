...
/**
 *
 * 1.support rule:[com.itangcent.idea.plugin.api.export.ecsb.EcsbClassExportRuleKeys.TAG]
 * 2.support rule:[com.itangcent.idea.plugin.api.export.ecsb.EcsbClassExportRuleKeys.STATUS]
 * 3.support rule:[com.itangcent.idea.plugin.api.export.ecsb.EcsbClassExportRuleKeys.OPEN]
 */
@ConditionOnChannel("ecsb")
class EcsbRequestBuilderListener : RequestBuilderListener {
    ...
    private fun trySetDemo(exportContext: ExportContext, extensible: Extensible) {
        ...
        val demo = ruleComputer.computer(EcsbClassExportRuleKeys.PARAM_DEMO, paramContext.element())
    ...
    override fun processCompleted(methodExportContext: MethodExportContext, request: Request) {
        ...
        val tags = ruleComputer.computer(EcsbClassExportRuleKeys.TAG, methodExportContext.element())
        ...
        val status = ruleComputer.computer(EcsbClassExportRuleKeys.STATUS, methodExportContext.element())
        request.setStatus(status)

        val open = ruleComputer.computer(EcsbClassExportRuleKeys.OPEN, methodExportContext.element())
