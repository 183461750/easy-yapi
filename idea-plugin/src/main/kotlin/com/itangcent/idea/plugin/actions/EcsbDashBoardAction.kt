...
import com.itangcent.idea.plugin.api.dashboard.EcsbDashBoard
...
class EcsbDashBoardAction : ApiExportAction("EcsbDashBoard") {
    ...
    override fun afterBuildActionContext(event: AnActionEvent, builder: ActionContext.ActionContextBuilder) {
        ...
        builder.bind(EcsbDashBoard::class) { it.singleton() }

        builder.bind(EcsbApiDashBoardExporter::class) { it.singleton() }
    ...
    override fun actionPerformed(actionContext: ActionContext, project: Project?, anActionEvent: AnActionEvent) {
        ...
        val apiDashBoard = actionContext.instance(EcsbDashBoard::class)
