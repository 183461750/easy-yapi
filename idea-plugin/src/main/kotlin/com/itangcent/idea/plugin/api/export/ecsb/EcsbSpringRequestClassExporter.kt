...
open class EcsbSpringRequestClassExporter : SpringRequestClassExporter() {

    @Inject
    private lateinit var ecsbSettingsHelper: EcsbSettingsHelper
    ...
    override fun resolveParamStr(
        ...
        when {
            ...
            !params.contains('=') -> {
                ...
                if (ecsbSettingsHelper.enableUrlTemplating()) {
