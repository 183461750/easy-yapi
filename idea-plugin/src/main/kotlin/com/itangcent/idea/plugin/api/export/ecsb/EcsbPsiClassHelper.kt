 ...
 * 3. field.advanced
 */
class EcsbPsiClassHelper : CustomizedPsiClassHelper() {
    ...
    override fun afterParseField(
        ...
        //compute `field.mock`
        ruleComputer.computer(EcsbClassExportRuleKeys.FIELD_MOCK, accessibleField)
        ...
        val advancedValue = ruleComputer.computer(
            EcsbClassExportRuleKeys.FIELD_ADVANCED,
            accessibleField
        )
